...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '377f8d3fb2b84e68912ce2cad8122c24,en:377f8d3fb2b84e68912ce2cad8122c24',
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'A Cyber Guy🍚 focusing on Cyber', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.51sec.org', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notes, Notion, Blog, Netsec, 51sec, Thinking, Effective', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi，this is Netsec, Hi，welcome to my notes site,Hi，welcome! this is Netsec say hello to you!🎉',
  // uuid重定向至 slug
